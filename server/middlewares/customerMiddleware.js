...
exports.isAuthenticated = async (req, res, next) => {
  try {
    let query = "select * from customer_token where token = $1";
    ...
    query =
      "SELECT id, full_name, username, email, mobile_number, latitude, longitude, created_at, updated_at from Customers where id = $1";
    params = [userId];
