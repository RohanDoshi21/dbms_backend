...
exports.isAuthenticated = async (req, res, next) => {
    try {
        let query = "select * from vendor_token where token = $1";
        ...
        const userId = data.rows[0].fk_vendor;
        query =
            "SELECT id, full_name, username, email, mobile_number, latitude, longitude, created_at, updated_at from Vendors where id = $1";
        params = [userId];
